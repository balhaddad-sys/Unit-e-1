...
//
// Each chain is 4-6 steps. Every step matters:
// - Some require travel to specific zones
// - Many require duels at the climax
// - Several have their own branch points where character is shaped
// - Completion grants permanent traits and unlocks downstream content
//
// These chains carry the bulk of the playtime. Each takes 3-6 in-game days.
...
export const personalChains: Record<string, PersonalChain> = {
  // ═══════════════════════════════════════════════════════════════
  // BU KHALID — The Last Headline
  // 5 steps. Final branch: take the deal honorably or extract a kickback.
  // ═══════════════════════════════════════════════════════════════
  "Bu Khalid": {
    npc: "Bu Khalid",
          ...
          options: [
            {
              ...
              effect: (s) => {
                ...
                // Bu Khalid respects you forever, but no extra money.
              },
            },
            {
              id: "take_kickback",
              ...
              effect: (s) => {
                ...
                // The money was real. So is the leverage Bu Khalid now has on you.
                s.favors.push({
                  who: "Bu Khalid",
                  kind: "youOwe",
                  weight: "major",
  ...
  // ═══════════════════════════════════════════════════════════════
  // UMM NASSER — Keeper of the Ledger
  // Teaches you how the favor economy actually works.
  // ═══════════════════════════════════════════════════════════════
  "Umm Nasser": {
    npc: "Umm Nasser",
  ...
  // ═══════════════════════════════════════════════════════════════
  // NASSER AL-QALLAF — Training the Shaheen
  // ═══════════════════════════════════════════════════════════════
  "Nasser Al-Qallaf": {
  ...
  // ═══════════════════════════════════════════════════════════════
  // SHEIKHA LATIFA — The Mentorship Circle
  // ═══════════════════════════════════════════════════════════════
  "Sheikha Latifa": {
    npc: "Sheikha Latifa",
  ...
  // ═══════════════════════════════════════════════════════════════
  // MUBARAK AL-HAWAJ — The Third Stall
  // ═══════════════════════════════════════════════════════════════
  "Mubarak Al-Hawaj": {
