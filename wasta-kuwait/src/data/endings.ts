...
//
// Endings fire when Act 5 is completed. The endingPath set in Act 5 is a
// suggestion — but the EARNED ending is computed from the player's full
// trajectory: traits, factions, completed chains, money, the choices that
// defined them.
//
// This is where the game reveals what you became.
...
export const endings: Ending[] = [
  // ─────────────────────────────────────────────────────────────
  // BROKER — accepted the council seat, balanced influence
  // The "good" ending if you wanted formal power.
  // ─────────────────────────────────────────────────────────────
  {
    id: "broker",
  ...
  // ─────────────────────────────────────────────────────────────
  // INDEPENDENT — refused the seat, stayed free
  // For the player who values agency over title.
  // ─────────────────────────────────────────────────────────────
  {
    id: "independent",
    title: "The Free Hand",
  ...
  // ─────────────────────────────────────────────────────────────
  // BETRAYER KING — climbed by stepping on people
  // Power without love. The path of ruthlessness.
  // ─────────────────────────────────────────────────────────────
  {
    id: "betrayer_king",
  ...
  // Married, has children, built something to pass on.
  // ─────────────────────────────────────────────────────────────
  {
    id: "patriarch",
    title: "The Patriarch",
  ...
  // ─────────────────────────────────────────────────────────────
  // ASCETIC — gave up public life for piety
  // The Pious + Hajji path.
  // ─────────────────────────────────────────────────────────────
  {
    id: "ascetic",
  ...
  // ─────────────────────────────────────────────────────────────
  // EXILED — burned bridges, never recovered
  // Compromised + bridges burned.
  // ─────────────────────────────────────────────────────────────
  {
    id: "exiled",
  ...
  // Wasta and rep stayed underwater. The cautionary tale.
  // ─────────────────────────────────────────────────────────────
  {
    id: "ruined",
  ...
  // ─────────────────────────────────────────────────────────────
  // MERCHANT LORD — built a trading empire
  // Calculating + high money + merchants faction high.
  // ─────────────────────────────────────────────────────────────
  {
    id: "merchant_lord",
  ...
  // ─────────────────────────────────────────────────────────────
  // TRIBE HEAD — returned to lead the desert family
  // Loyal + tribal_son flag + Act 5 tribe choice.
  // ─────────────────────────────────────────────────────────────
  {
    id: "tribe_head",
  ...
  // ─────────────────────────────────────────────────────────────
  // IMAM — took religious leadership
  // Pious + completed religious chains.
  // ─────────────────────────────────────────────────────────────
  {
    id: "imam",
    ...
    check: (s) =>
      ...
      s.relationships["Sheikh Abdullah"] >= 90,
  },
];

export function determineEnding(s: GameState): Ending {
  // Try each ending in priority order. The most specific ones come first.
  // (Some endings have overlapping conditions; the first match wins.)
