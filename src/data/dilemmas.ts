...
export const dilemmas: Dilemma[] = [
  ...
  },
  {
    ...
    accept: { label: "Apologize publicly, in front of everyone", rep: 3, energy: -5 },
    refuse: { label: "Let it cool — they'll forget", rep: -2 },
  },
  {
    ...
    accept: { label: "Mediate the dispute", wasta: 4, rep: 1, energy: -15 },
    refuse: { label: "Stay neutral and pray", rep: -3 },
    third: {
  ...
  },
  {
    ...
    accept: { label: "Forgive the debt — wallah it's nothing", money: -200, rep: 5, wasta: 3 },
    refuse: { label: "Insist — debts are debts", money: 200, rep: -3 },
  },
  {
    id: "the_whisper",
    tag: "The room",
    ...
    accept: { label: "Correct the record", rep: 4, energy: -6, factions: { tribal: 2 } },
    refuse: { label: "Let it travel — not your business", rep: -1, wasta: 1 },
  },
  ...
  // ── COMEDY ──
  {
    ...
    accept: { label: "Lean into it — make a joke about it", rep: 3, energy: -3 },
    refuse: { label: "Hide your feet under the table all night", rep: -2 },
  },
  {
    id: "wrong_whatsapp",
    tag: "Comedy",
    ...
    accept: { label: "Apologize, explain, accept the teasing", rep: 1, energy: -2 },
    refuse: { label: "Delete-for-everyone — but they all saw", rep: -3 },
  },
  {
    ...
    accept: { label: "Send it. Again. (مالك إلا الصبر)", money: -50, rep: 1 },
    refuse: { label: "Tell him you're broke", rep: -1, wasta: 1 },
    third: {
  ...
  },
  {
    ...
    accept: { label: "Buy a new one — what can you do, she meant well", money: -180, rep: 1, energy: -5 },
    refuse: { label: "Snap at her and regret it for a week", rep: -3, energy: -8 },
  },
  {
    id: "karak_emergency",
    tag: "Comedy",
    ...
    accept: { label: "Drive 20 minutes to the good karak place", money: -15, rep: 2, energy: 5 },
    refuse: { label: "Drink the bad karak in silence", rep: -1 },
  },
  {
    id: "wedding_dance",
    tag: "Comedy",
    ...
    accept: { label: "Dance — commit fully — embarrass yourself with dignity", rep: 3, energy: -6, factions: { tribal: 2 } },
    refuse: { label: "Hide in the bathroom until they finish", rep: -2 },
  },
  {
    id: "eidiya_problem",
    tag: "Comedy",
    ...
    accept: { label: "Withdraw cash from the secret stash, top up quickly", money: -90, rep: 4, energy: -3 },
    refuse: { label: "Stretch the envelopes — claim it's a misunderstanding", rep: -5, factions: { tribal: -3 } },
  },
  {
    id: "the_haircut",
    tag: "Comedy",
    ...
    accept: { label: "Own it — claim it was on purpose", rep: 2, energy: -2 },
    refuse: { label: "Wear a ghutra low for two weeks", rep: -1 },
  },
  ...
  // ── ANGER ──
  {
    ...
    accept: { label: "Get out of the car and have words", rep: -2, energy: -8 },
    refuse: { label: "Breathe. Let it pass.", rep: 1, energy: -2 },
  },
  {
    id: "line_skipper",
    tag: "Confrontation",
    ...
    accept: { label: "Call him out loudly. Everyone needs to hear.", rep: 3, wasta: -2, energy: -10 },
    refuse: { label: "Say nothing — pick your battles", rep: -1, energy: -3, wasta: 1 },
  },
  {
    id: "the_accused",
    tag: "Honor",
    ...
    accept: { label: "Stand — defend the family name", rep: 6, wasta: 3, energy: -12, factions: { tribal: 4 } },
    refuse: { label: "Sit silent — and lose everything that mattered", rep: -8, wasta: -4 },
    third: {
  ...
  },
  {
    ...
    accept: { label: "Speak to the manager — politely", rep: 1, money: -30, energy: -5 },
    refuse: { label: "Tip badly and leave", rep: -1, energy: -2 },
  },
  {
    id: "the_broken_lift",
    tag: "Confrontation",
    ...
    accept: { label: "Confront him publicly — embarrass him into fixing it", rep: 2, energy: -8 },
    refuse: { label: "Keep climbing the stairs — stay civil", rep: 1, energy: -5 },
  },
  ...
  // ── SHAME ──
  {
    ...
    accept: { label: "Apologize fifteen times — send flowers", rep: -8, wasta: -3, energy: -10, money: -100 },
    refuse: { label: "Pretend it didn't happen", rep: -15, factions: { merchants: -5 } },
  },
  {
    id: "butt_dial",
    tag: "Shame",
    ...
    accept: { label: "Pick up. Apologize. Take the consequences.", rep: -5, wasta: 2, energy: -15 },
    refuse: { label: "Let it ring out — hide for three days", rep: -12, wasta: -6 },
  },
  {
    ...
    accept: { label: "Show up to the after-party with a huge gift", money: -200, rep: -3, wasta: -2, energy: -12 },
    refuse: { label: "Make up an illness — pray they don't ask which doctor", rep: -10, factions: { tribal: -5 } },
  },
  {
    ...
    refuse: { label: "Address it privately — let the group forget", rep: -5 },
  },
  ...
  // ── RISK ──
  {
    ...
    refuse: { label: "Decline — too good to be true", rep: 1 },
  },
  {
    id: "card_game",
    tag: "Risk",
    ...
    refuse: { label: "Bow out — \"My wife will kill me\"", rep: 1 },
  },
  {
    id: "falcon_bet",
    tag: "Risk",
    ...
    refuse: { label: "Don't bet — just watch" },
  },
  {
    id: "real_estate_tip",
    tag: "Risk",
  ...
  },
  {
    ...
    accept: { label: "Attend all three days", rep: 8, energy: -25, factions: { tribal: 5, religious: 3 } },
    refuse: { label: "Send your apologies — appear briefly day one", rep: -8, factions: { tribal: -6 } },
  },
  {
    id: "borrowed_car",
    tag: "Family",
    ...
    accept: { label: "Pay for the repair — let him save face", money: -80, rep: 1 },
    refuse: { label: "Confront him — make him pay", rep: -3, energy: -8 },
  },
  {
    id: "bahraini_aunt",
    tag: "Family",
    ...
    accept: { label: "Smile and nod for two weeks", rep: 2, energy: -15 },
    refuse: { label: "Snap at her — and hear about it for ten years", rep: -5, factions: { tribal: -3 } },
  },
  {
    id: "father_sick",
    tag: "Family",
    ...
    refuse: { label: "Visit briefly each evening — keep working", rep: -3 },
  },
  ...
  // ── ROMANCE ──
  {
    ...
    accept: { label: "Speak to them — risk it again", rep: -2, wasta: -1, energy: -8, flag: "rekindled" },
    refuse: { label: "Walk past — the past is the past", rep: 1 },
  },
  {
    id: "letter",
    tag: "Heart",
    ...
    accept: { label: "Reply — what do you have to lose?", energy: -5, rep: 1, flag: "replied_to_letter" },
    refuse: { label: "Burn it. Some doors close for a reason." },
  },
  {
    id: "the_cafe_meeting",
    tag: "Heart",
    ...
    accept: { label: "Pursue this — you are not getting younger", rep: -2, wasta: -3, energy: -10, flag: "courting" },
    refuse: { label: "End it cleanly. Marry someone your family chooses.", rep: 2, factions: { tribal: 2 } },
  },
  ...
  // ── CRISIS ──
  {
    ...
    accept: { label: "Hire the best lawyer — fight clean", money: -800, wasta: -5, energy: -20, rep: 3 },
    refuse: {
  ...
  },
  {
    ...
    accept: { label: "Make a public statement, hire a media person", rep: -8, wasta: -3, energy: -25, money: -300 },
    refuse: {
  ...
  // ── CHALLENGE ──
  {
    ...
    accept: { label: "Challenge him to a Gahwa Duel", energy: -10, rep: 5, wasta: 3, triggerDuel: "gahwa" },
    refuse: { label: "Let him have the room — for now", rep: -3, wasta: -2 },
  },
  {
    id: "young_lion",
    tag: "Challenge",
    ...
    accept: { label: "Accept — show him what experience looks like", energy: -15, rep: 6, wasta: 4, triggerDuel: "debate" },
    refuse: { label: "Refuse — \"my time is more valuable than this\"", rep: -5, wasta: -3 },
  },
];
