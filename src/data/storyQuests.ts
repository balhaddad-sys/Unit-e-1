...
//
// PRINCIPLES:
// - Each branch grants a permanent Trait that gates future content.
// - WorldFlags set here unlock or lock future quests, NPCs, and endings.
// - The "easy" path always exists — but the "real" one requires character.
...
export const storyQuests: StoryQuest[] = [
  // ─────────────────────────────────────────────────────────────
  // ACT 1 — Cup of Welcome
  // The Newcomer must earn Umm Nasser's nod.
  // Branch: Tribal embrace vs Maintained distance.
  // ─────────────────────────────────────────────────────────────
  {
    id: "sq_act1",
    act: "newcomer",
      ...
      options: [
        {
          ...
          effect: (s) => {
            ...
            // Unlock: she will share secrets, faster relationship growth with tribal NPCs
          },
        },
        {
          id: "polite_distance",
          ...
          effect: (s) => {
            ...
            s.factions.tribal += 2; // still positive, but less
            addTrait(s, "calculating");
            s.worldFlags.kept_distance = true;
            // Allows working freely with non-tribal factions later
          },
        },
        {
          id: "honest_refusal",
  ...
  // ─────────────────────────────────────────────────────────────
  // ACT 2 — The Permits Crisis
  // Bu Yousef needs your name on a reform.
  // Branch: Public push (visible) vs Quiet maneuver vs Refuse to be used.
  // ─────────────────────────────────────────────────────────────
  {
    id: "sq_act2",
    act: "riser",
      ...
      options: [
        {
          ...
          effect: (s) => {
            ...
            // Public figure: more rep gain from events, but enemies more visible
          },
        },
        {
          id: "quiet_maneuver",
        ...
        },
        {
          ...
          effect: (s) => {
            ...
            // Locks: Sheikh Abdullah's deepest chains, the Hajj quest line
          },
        },
      ],
    },
  ...
  // ─────────────────────────────────────────────────────────────
  // ACT 3 — The Falcon and the Flag
  // Two competing events the same evening.
  // Branch: Desert (tribal) vs City (merchants) vs Both (split yourself).
  // ─────────────────────────────────────────────────────────────
  {
    id: "sq_act3",
    act: "operator",
      ...
      options: [
        {
          ...
          effect: (s) => {
            ...
            // Unlocks: Bu Mishari's deepest chain. Locks: certain merchant deals.
          },
        },
        {
          id: "honor_city",
          ...
          effect: (s) => {
            ...
            // Unlocks: Sheikha Latifa's mentorship final, business expansion
          },
        },
        {
          id: "split_evening",
          ...
          effect: (s) => {
            ...
            // Both factions partly happy, but rep takes a hit and you'll
            // be remembered as the man who tried to do both. Some respect this,
        ...
        },
        {
          ...
          effect: (s) => {
            ...
            // The phantom of the missed evening follows you
          },
        },
      ],
    },
  ...
  // ─────────────────────────────────────────────────────────────
  // ACT 4 — The Mediator's Burden
  // Two old families in dispute over land. Sheikh Abdullah asks you to mediate.
  // The wrong handling costs you everything you've built.
  // ─────────────────────────────────────────────────────────────
  {
    id: "sq_act4",
    act: "insider",
      ...
      options: [
        {
          ...
          effect: (s) => {
            ...
            // The legend that follows you. Major rep multiplier.
          },
        },
        {
          id: "favor_one_side",
          ...
          effect: (s) => {
            ...
            // The truth comes out in Act 5. Always.
          },
        },
        {
          id: "refuse_burden",
          ...
          effect: (s) => {
            s.stats.rep += 5; // some respect this
            s.factions.religious -= 3;
            s.stats.wasta -= 10;
            addTrait(s, "honorable");
            s.worldFlags.refused_mediation = true;
            // Sheikh Abdullah is not angry but quietly disappointed.
            // Different ending paths open.
          },
        },
        {
          ...
          effect: (s) => {
            ...
            // The cost was real but the result holds
          },
        },
      ],
    },
  ...
  // ─────────────────────────────────────────────────────────────
  // ACT 5 — The Quiet Throne
  // The endgame. Sheikha Latifa offers you a council seat.
  // The actual ending depends on accumulated traits + worldFlags + factions.
  // ─────────────────────────────────────────────────────────────
  {
    id: "sq_act5",
    act: "broker",
